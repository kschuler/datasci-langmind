...
Data science is about making decisions based on incomplete information. This concept is not new -- brains (especially human brains!) love doing this. While the underlying concept is not new, the computational tools we use are *relatively* new. And we have a lot more data! 
