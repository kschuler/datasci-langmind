...
## Cross validation v. F-test: 

- **Cross validation**: a predictive performance approach. How well does our model generalize to unseen data? 

- **F-test** a statistical test comparing two or more nested models. Is $R^2$ significantly higher?
