---
title:  "Problem set 2"
subtitle: "due Monday, September 16, 2025 at 11:59am (noon!)"
# author: 
#     name: Katie Schuler
...
Create a spreadsheet in Google sheets with data from the following table. Download your spreadsheet as a CSV file and upload it into Colab. Then, use the appropriate function from the `readr` package to import your CSV file into R. Return or print your imported data to confirm it was read in correctly. 
